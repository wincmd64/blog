:: Adds "View .pol content" entry to the Explorer context menu
...
reg add "HKCU\Software\Classes\SystemFileAssociations\.pol\shell\wincmd64_pol" /v "MUIVerb" /d "View .pol content" /f
