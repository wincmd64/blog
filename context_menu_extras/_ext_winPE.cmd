...
for /f "tokens=* delims=" %%a in ('where TBWinPE.exe') do set "TBWinPE=%%a"
if exist "%TBWinPE%" (
    ...
    echo. & echo TBWinPE.exe not found. Pls download from: https://www.terabyteunlimited.com/downloads/wp/tbwinpe.zip & echo.
    pause & exit
)
