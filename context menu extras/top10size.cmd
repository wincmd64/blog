:: Adds "Top 10 by Size (recursively)" menu entry to the Explorer context menu (hold Shift to activate)
:: [area] dirs
...
reg add "HKCU\Software\Classes\Directory\shell\wincmd64_Top10size" /v "MUIVerb" /d "Top 10 by Size (recursively)" /f
