...
for /f "tokens=* delims=" %%a in ('where innounp.exe') do set "innounp=%%a"
if exist "%innounp%" (
    ...
    echo. & echo innounp.exe not found. Pls download from: https://www.rathlev-home.de/index-e.html?tools/prog-e.html#unpack & echo.
    pause & exit
)
